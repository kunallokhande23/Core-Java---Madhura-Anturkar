...
public class StudentCollectionUtils {
	...
	public static Stream<Student> sortStudentsByGPA(Map<String, Student> map)
	{
	...
	//add static method to sort student details as per DoB
		public static Stream<Student> sortStudentsByDob(Map<String, Student> map)
		{
			return map.values() //Collection<Student>
					.stream() //Stream<Student>
